...
class CollectionsHelperTest < ActionView::TestCase
  ...
  test 'graphml path helper' do
    assert_equal '/TEST/401/1234/1/derivatives/gephi/1234-gephi.graphml',
                 graphml_path(@collections_one.user_id,
                              @collections_one.collection_id,
                              @collections_one.account)
    assert_equal '/TEST/401/3490/2/derivatives/gephi/3490-gephi.graphml',
  ...
  test 'fulltext path helper' do
    assert_equal '/TEST/401/1234/1/derivatives/all-text/1234-fulltext.txt',
                 fulltext_path(@collections_one.user_id,
                               @collections_one.collection_id,
                               @collections_one.account)
    assert_equal '/TEST/401/3490/2/derivatives/all-text/3490-fulltext.txt',
  ...
  test 'domains path helper' do
    assert_equal '/TEST/401/1234/1/derivatives/all-domains/1234-fullurls.txt',
                 domains_path(@collections_one.user_id,
                              @collections_one.collection_id,
                              @collections_one.account)
    assert_equal '/TEST/401/3490/2/derivatives/all-domains/3490-fullurls.txt',
